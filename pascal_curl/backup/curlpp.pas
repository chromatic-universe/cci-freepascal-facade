         ...
         { h_curl := curl_easy_init();
          ...
          try
            ...
            begin
              user :=  'dasovich-j';
              passwd := 'Argentina1';
              dsn := 'imaps://chromatic-universe-expansion:10000/INBOX/;UID=45';
              stream := nil;
            end;
            naked[1] :=  n_param;
            with n_param do
            begin
              user :=  'dasovich-j';
              passwd := 'Argentina1';
              dsn := 'imaps://chromatic-universe-expansion:10000/INBOX/;UID=46';
              stream := nil;
            end;
            naked[2] :=  n_param;
            with n_param do
            begin
              user :=  'dasovich-j';
              passwd := 'Argentina1';
              dsn := 'imaps://chromatic-universe-expansion:10000/INBOX/;UID=47';
              stream := nil;
            end;
            naked[3] :=  n_param;
            with n_param do
            begin
              user :=  'dasovich-j' ;
              passwd := 'Argentina1';
              dsn := 'imaps://chromatic-universe-expansion:10000/INBOX/;UID=48';
              stream := nil;
            end;
            naked[4] :=  n_param;
            //naked[1] :=  n_param;
